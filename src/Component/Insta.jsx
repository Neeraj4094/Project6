...
function Insta() {
  return (
    <>
    <section className="relative bg-slate-200 py-20 md:py-32 overflow-hidden">
        ...
        <div className="flex -mx-4">
          ...
          <div className="w-full md:w-1/3 lg:w-1/4 px-4">
            <a className="group block max-w-sm mx-auto md:max-w-none h-full border border-gray-100 bg-white rounded-xl transform hover:scale-105 transition duration-500" href="#">
              <div className="flex items-center justify-between px-4 py-5">
                <span className="text-sm">@saturn_ui</span>
                <i class='bx bxl-snapchat'style={{color:'black'}}  ></i>
              </div>
              <div className="h-72">
          ...
          <div className="w-full md:w-1/3 lg:w-1/4 px-4">
            <a className="group block max-w-sm mx-auto md:max-w-none h-full border border-gray-100 bg-white rounded-xl transform hover:scale-105 transition duration-500" href="#">
              <div className="flex items-center justify-between px-4 py-5">
                <span className="text-sm">@saturn_ui</span>
                <i class='bx bxl-telegram' style={{color:'black'}}  ></i>
              </div>
              <div className="h-72">
