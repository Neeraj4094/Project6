        ...
        <div className="bg-gray-900">
          <div className="container px-4 mx-auto">
            <div className="flex flex-wrap xs:h-16 py-4 items-center">
              ...
              <a
                className="inline-block text-sm text-green-500 font-bold"
                href="#"
              >
                Product
              </a>
